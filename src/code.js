    ...
    for (const [pageId, frames] of pageGroupedFrames.entries()) {
      ...
      for (let i = 0; i < frames.length; i++) {
        ...
        const textDivs = targetLayers.map(layer => {
          ...
          const className = `layer-${layerType} layer-suspect`;
